  ...
  return (
    ...
    <div className="hidden md:block w-full">
      ...
      <div className="relative overflow-hidden rounded-3xl text-center text-white">
        ...
        <Image src="/banner.png" className="rounded-lg" fill={true} />

        <div className="relative"><div className="py-20 [filter:drop-shadow(0_0_2.5rem_black)]">

          <h1 className="m-auto mb-2 text-5xl font-black tracking-tighter [filter:drop-shadow(0_0_1rem_black)] md:w-[750px] md:text-7xl">Create AI Covers with your Favorite Voices</h1>
